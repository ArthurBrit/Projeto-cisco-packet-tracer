...
Durante a atividade, foi necessário configurar um servidor na rede para permitir o acesso a páginas web pelos outros dispositivos. Após a configuração do servidor e do endereço IP, criamos uma página simples em HTML e a colocamos no servidor para testar o funcionamento.


### 📷 Evidências Visuais

<img src="assets/Representação visual.png" width="800">
